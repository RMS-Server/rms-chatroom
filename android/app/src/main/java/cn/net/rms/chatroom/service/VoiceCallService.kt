...
class VoiceCallService : Service() {
    ...
    companion object {
        ...
        const val ACTION_MUTE = "cn.net.rms.chatroom.ACTION_MUTE"
        const val ACTION_UNMUTE = "cn.net.rms.chatroom.ACTION_UNMUTE"
        const val ACTION_HANG_UP = "cn.net.rms.chatroom.ACTION_HANG_UP"
